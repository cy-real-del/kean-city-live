...
const textTranslations = {
  en: {
    ...
    "Заявка": "Request",
    "Прибрежный Лимассол": "Coastal Limassol",
    ...
    "Локация": "Location",
    "Прибрежный Лимассол: море, парк Dasoudi и городская жизнь в одном сценарии.": "Coastal Limassol: the sea, Dasoudi Park and city life in one scenario.",
...
Object.assign(textTranslations.en, {
  ...
  "Прибрежный Лимассол: море, парк Dasoudi и городская жизнь в одном адресе.": "Coastal Limassol: the sea, Dasoudi Park and city life in one address.",
